...
*/
	...
	main_timer.start();
	// std::cout << t.measure_egg_type() << std::endl;
	//     std::cout << "ADC1   " << rlink.request(ADC1) << std::endl;
	//     std::cout << "ADC2   " << rlink.request(ADC2) << std::endl;
	//     std::cout << "ADC3   " << rlink.request(ADC3) << std::endl;
	//     delay(500);
