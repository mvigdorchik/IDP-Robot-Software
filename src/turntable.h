...
#define TURNTABLE_ROTATION_SPEED 20.0 //Converts from degrees to time
...
#define DOUBLE_LINE_TIMEOUT 10 //Timeout for detecting a new line
#define MIN_TIME_DETECTION 0.5 //Min time so that it doesn't register the same line twice
#define TIME_TO_REVERSE 3.5 //Time to center on the nest for initial alignment
